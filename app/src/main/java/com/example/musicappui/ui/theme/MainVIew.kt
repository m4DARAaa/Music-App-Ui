...
fun MainView() {
    ...
    val modifier=if (isSheetFullScreen)Modifier.fillMaxWidth() else Modifier.fillMaxWidth()
    val modalSheetState=androidx.compose.material.
        ...
        if (currentScreen is Screen.DrawerScreen || currentScreen == Screen.BottomScreen.Home) {
            BottomNavigation(modifier = Modifier.wrapContentSize()) {
                screensInBottom.forEach { item ->
                    ...
                    Log.d(
                        "Navigation",
                        "Item:${item.bRoute},CurrentRoute:$currentRoute,Is Selected"
                    )
